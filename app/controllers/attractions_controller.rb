class AttractionsController < ApplicationController
  ...
  def show
    ...
    @weather = HTTParty.get( url )  #return JSON

    #Geocoder gem call, 20km around point
    @venues = Attraction.near([lat, lng],20, :units=>:km)  #return array of objects, used in attraction show page
  end
